...
public class setProfile extends AppCompatActivity {
    ...
    private android.widget.Button msaveprofille;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msaveprofille =findViewById(R.id.saveProfile);
        ...
        msaveprofille.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void sendDataToRealTimeDatabase(){
        ...
        DatabaseReference databaseReferenc =firebaseDatabase.getReference(firebaseAuth.getUid());
        userprofile muserprofile =new userprofile(name ,firebaseAuth.getUid());
        databaseReferenc.setValue(muserprofile);
        Toast.makeText(getApplicationContext(), "User Profile Added Sucessfully", Toast.LENGTH_SHORT).show();
        Intent intent3=new Intent(setProfile.this, chatActivity.class);
