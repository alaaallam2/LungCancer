...
import com.example.lungcancer.Model.Data;
import com.example.lungcancer.Model.Notifications;
import com.example.lungcancer.Model.Posts;
import com.example.lungcancer.OthersProfile;
import com.example.lungcancer.PostDetails;
...
public class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
       ...
       //holder.username.setText(notifications.getname());
        holder.comment.setText(notifications.getComment());
     // holder.username.setText(holder.username.getText());

        holder.username.setText(notifications.getPostid());
